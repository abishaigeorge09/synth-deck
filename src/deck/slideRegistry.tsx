...
export const MAIN_FLOW_SLIDES: RegisteredSlide[] = [
  { id: 's02a', section: '01 · PROBLEM', background: THEME.light, render: (nav) => <S02a_ProblemStatements {...nav} /> },
  { id: 's02', section: '01 · PROBLEM', background: THEME.light, render: (nav) => <S02_Problem {...nav} /> },
  { id: 's03a-scope', section: '01 · PROBLEM', background: THEME.light, render: (nav) => <S03a_ProblemEverywhere {...nav} /> },
  { id: 's02-solution', section: '02 · SOLUTION', background: THEME.primary, render: (nav) => <OurSolutionCover {...nav} /> },
  { id: 's02-solution-overview', section: '02 · SOLUTION', background: THEME.light, render: (nav) => <S03_SolutionOverview {...nav} /> },
  ...
  { id: 's11', section: 'VISION', background: THEME.light, render: (nav) => <S11_Vision {...nav} /> },
  { id: 's12', section: 'CLOSE', background: THEME.light, render: (nav) => <S12_Close {...nav} /> },
